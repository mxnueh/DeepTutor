...
def _login_openai_codex() -> None:
    try:
        ...
        typer.echo("oauth_cli_kit is not installed. Install CLI deps: pip install -U deeptutor-cli")
...
async def _login_github_copilot() -> None:
    ...
    try:
        ...
        typer.echo("openai is not installed. Install CLI deps: pip install -U deeptutor-cli")
        raise typer.Exit(code=1)
    try:
        client = AsyncOpenAI(
            api_key="copilot",
